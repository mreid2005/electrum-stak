...
from electrum_stak.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        ...
        try:
            uri = electrum_stak.util.parse_URI(text, self.app.on_pr)
        except:
    ...
    def do_save(self):
        ...
        from electrum_stak.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_stak.util import create_URI
