...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_stak.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_stak"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_stak:externalType",
                '',
                data)
        return extRecord
