...
class TestTransaction(unittest.TestCase):
    ...
    def test_tx_unsigned(self):
        expected = {
            ...
            'lockTime': 0,
            'outputs': [{
                'address': 'SQVHaRMLi6VmMFrFpcojmFnQMFCxcNjAUm',
                'prevout_n': 0,
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(estimated_output_size('SfUoikatbLuarpSkCXnia8jBsAK1kWWR9j'), 34)
        self.assertEqual(estimated_output_size('3K5dP5LZesCLX6V3aeVqpnV5UkS6PCTsKT'), 32)
        self.assertEqual(estimated_output_size('stak1quunc907zfyj7cyxhnp9584rj0wmdka2ec9w3af'), 31)
        self.assertEqual(estimated_output_size('stak1qp8f842ywwr9h5rdxyzggex7q3trvvvaarfssxccju52rj6htfzfsqr79j2'), 43)
    ...
    def test_parse_xpub(self):
        ...
        self.assertEqual(res, ('04ee98d63800824486a1cf5b4376f2f574d86e0a3009a6448105703453f3368e8e1d8d090aaecdd626a45cc49876709a3bbb6dc96a4311b3cac03e225df5f63dfc', 'SVz95tRDN5XocS3z3YFBdJXCg6kL6pyy4D'))
