...
class TestWalletKeystoreAddressIntegrity(unittest.TestCase):
    ...
    def test_electrum_seed_standard(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'SifkvjZAHHgUA8xxbpQBYpkcDjGhspqd5P')
        self.assertEqual(w.get_change_addresses()[0], 'Sfjf2P8qtfYiMZNwnc1PRbhEjviFYXM3V2')
    ...
    def test_electrum_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'stak1q3g5tmkmlvxryhh843v4dz026avatc0zz2wa56a')
        self.assertEqual(w.get_change_addresses()[0], 'stak1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjs2erd4')
    ...
    def test_electrum_seed_old(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'SbbEG1usRkYoXAouHmkvb1mrdCVRGryMji')
        self.assertEqual(w.get_change_addresses()[0], 'SfiWAf4F1cUmDRuc2epBD8UVRe7BxLPBqc')
    ...
    def test_bip39_seed_bip44_standard(self, mock_write):
        ...
        ks = keystore.from_bip39_seed(seed_words, '', "m/44'/187'/0'")
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'SfUoikatbLuarpSkCXnia8jBsAK1kWWR9j')
        self.assertEqual(w.get_change_addresses()[0], 'ShXk2Sf2FAmtWkd3Crgt4LdMpMRf8qvqzj')
    ...
    def test_bip39_seed_bip49_p2sh_segwit(self, mock_write):
        ...
        ks = keystore.from_bip39_seed(seed_words, '', "m/49'/187'/0'")
        ...
        self.assertEqual(w.get_receiving_addresses()[0], '3Fns4aC4V3eoRzjxtNXnxkynKrskn6VpgG')
        self.assertEqual(w.get_change_addresses()[0], '38p7aLSdXt3Wdrdue2gQpqfV7eaeMUBrmM')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'stak1qcr8te4kr609gcawutmrza0j4xv80jy8zcmsvrg')
        self.assertEqual(w.get_change_addresses()[0], 'stak1q8c6fshw2dlwun7ekn9qwf37cu2rn755ugvtl7t')
    ...
    def test_electrum_multisig_seed_standard(self, mock_write):
        ...
        ks2 = keystore.from_xpub('xpub661MyMwAqRbcGNEPu3aJQqXTydqR9t49Tkwb4Esrj112kw8xLthv8uybxvaki4Ygt9xiwZUQGeFTG7T2TUzR3eA4Zp3aq5RXsABHFBUrq4c')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], '3K5dP5LZesCLX6V3aeVqpnV5UkS6PCTsKT')
        self.assertEqual(w.get_change_addresses()[0], '3BNFzWwiPCPHzTYGAdquGRL58L28EJBX1G')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'stak1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqeg4lky')
        self.assertEqual(w.get_change_addresses()[0], 'stak1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usz79g73')
    ...
    def test_bip39_multisig_seed_bip45_standard(self, mock_write):
        ...
        # der: m/45'/0
        ks2 = keystore.from_xpub('xpub69xafV4YxC6o8Yiga5EiGLAtqR7rgNgNUGiYgw3S9g9pp6XYUne1KxdcfYtxwmA3eBrzMFuYcNQKfqsXCygCo4GxQFHfywxpUbKNfYvGJka')
        self._check_xpub_keystore_sanity(ks2)
        self.assertTrue(isinstance(ks2, keystore.BIP32_KeyStore))
        ...
        self.assertEqual(w.get_receiving_addresses()[0], '3AXgsPd8dGMWVvrZXT3tr7Po3UP3tCEzF9')
        self.assertEqual(w.get_change_addresses()[0], '3E1beSCVr9zhzzFSaUpUV3qazKqmu17Uoy')
